...
public class EventRestControllerV1Test extends Mockito {
    @Mock
    ...
    private EventRestControllerV1 controllerUnderTest;
    private final String mappingUrl = "/api/v1/events/";

    public EventRestControllerV1Test() {
        MockitoAnnotations.openMocks(this);
        this.controllerUnderTest = new EventRestControllerV1(eventService);
    }
    ...
    public void doGetAll() throws IOException {
        ...
        verify(eventService, never()).getById(any(), any());
    }
    ...
    public void doGetById() throws IOException {
        ...
        verify(eventService, times(1)).getById("1", response);
    }
